				...
				<form action="alimento" method="post">
					...
					<div class="form-group" style="color:white">
						<label for="id-periodo">Período</label> <select name="periodo"
							...
							type=number class="form-control" name="usuario" placeholder="Ex: 8001">
					</div>
